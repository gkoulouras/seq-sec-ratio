# SeqSecAnalyzer
A console appication for the quantitative analysis of the Amino Acids and the estimation of the ratio of the Secondary Structure's elements. The input file should be the "ss.txt" file (Secondary Structure File - uncompressed). The "ss.txt" file can be found in compressed mode ("ss.txt.gz") at the official website of the <a href="https://www.rcsb.org/pdb/static.do?p=download/http/index.html">Protein Data Bank (PDB)</a>. The next step concerns the uncompression of the ss.txt.gz file. After that you should declare the full path of the directory which contains the ss.txt file. Upon successful execution, a report file will be generated within the directory of the executable. 
